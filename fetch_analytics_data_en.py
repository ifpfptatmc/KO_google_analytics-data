...
def get_report(client):
    request = RunReportRequest(
        ...
        metrics=[{"name": "activeUsers"}, {"name": "averageSessionDuration"}, {"name": "bounceRate"}, {"name": "eventCount"}],
...
def save_to_csv(response):
    ...
    df.to_csv('analytics_data_en.csv', index=False)
...
def main():
    ...
    print("Data fetched and saved to analytics_data_en.csv successfully.")
